...
public class WidgetUpdaterLarge extends Service implements Refreshable, WidgetUpdaterTools.CoinWidgetUpdater {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        ComponentName widget = new ComponentName(context,CoinWidgetLarge.class);
    	...
    	for (int appWidgetId:ids)
    		CoinWidgetLarge.updateWidget(context, CoinWidgetTools.prepareViews(context, appWidgetId, getCoinWidgetProvider(), getWidgetLayout()), appWidgetId);
	...
	public String getSize(){
		return WidgetUpdaterTools.SIZE_LARGE;
	}
}
